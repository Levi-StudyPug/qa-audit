...
async def main():
    ...
    if ca_guest:
        ...
        await take_screenshots_batch(
            urls=ca_guest,
            output_dir="screenshots/prod/mobile/ca/guest",
            viewport_width=390,
            viewport_height=844,
            use_auth=False
        )
    ...
    if ca_parent:
        ...
        await take_screenshots_batch(
            urls=ca_parent,
            output_dir="screenshots/prod/mobile/ca/parent",
            viewport_width=390,
            viewport_height=844,
            use_auth=True,
    ...
    if ca_student:
        ...
        await take_screenshots_batch(
            urls=ca_student,
            output_dir="screenshots/prod/mobile/ca/student",
            viewport_width=390,
            viewport_height=844,
            use_auth=True,
            auth_url="https://www.studypug.com/signin/ca/?role=student",
    ...
    if us_guest:
        ...
        await take_screenshots_batch(
            urls=us_guest,
            output_dir="screenshots/prod/mobile/us/guest",
            viewport_width=390,
            viewport_height=844,
            use_auth=False
        )
    ...
    if us_parent:
        ...
        await take_screenshots_batch(
            urls=us_parent,
            output_dir="screenshots/prod/mobile/us/parent",
            viewport_width=390,
            viewport_height=844,
            use_auth=True,
    ...
    if us_student:
        ...
        await take_screenshots_batch(
            urls=us_student,
            output_dir="screenshots/prod/mobile/us/student",
            viewport_width=390,
            viewport_height=844,
            use_auth=True,
    ...
    if uk_guest:
        ...
        await take_screenshots_batch(
            urls=uk_guest,
            output_dir="screenshots/prod/mobile/uk/guest",
            viewport_width=390,
            viewport_height=844,
            use_auth=False
        )
    ...
    if uk_parent:
        ...
        await take_screenshots_batch(
            urls=uk_parent,
            output_dir="screenshots/prod/mobile/uk/parent",
            viewport_width=390,
            viewport_height=844,
            use_auth=True,
    ...
    if uk_student:
        ...
        await take_screenshots_batch(
            urls=uk_student,
            output_dir="screenshots/prod/mobile/uk/student",
            viewport_width=390,
            viewport_height=844,
            use_auth=True,
    ...
    if au_guest:
        ...
        await take_screenshots_batch(
            urls=au_guest,
            output_dir="screenshots/prod/mobile/au/guest",
            viewport_width=390,
            viewport_height=844,
            use_auth=False
        )
    ...
    if au_parent:
        ...
        await take_screenshots_batch(
            urls=au_parent,
            output_dir="screenshots/prod/mobile/au/parent",
            viewport_width=390,
            viewport_height=844,
            use_auth=True,
    ...
    if au_student:
        ...
        await take_screenshots_batch(
            urls=au_student,
            output_dir="screenshots/prod/mobile/au/student",
            viewport_width=390,
            viewport_height=844,
            use_auth=True,
    ...
    if shared_guest:
        ...
        await take_screenshots_batch(
            urls=shared_guest,
            output_dir="screenshots/prod/mobile/shared/guest",
            viewport_width=390,
            viewport_height=844,
            use_auth=False
        )
